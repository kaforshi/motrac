...
<body class="h-screen bg-white font-sans text-slate-800">
    ...
    <div class="flex h-full w-full">
        ...
        <!-- Left Side: Branding / Visual (Blue Theme for Register) -->
        <div class="hidden lg:flex w-1/2 bg-gradient-to-br from-blue-600 to-indigo-900 text-white flex-col justify-between p-12 relative overflow-hidden">
            <!-- Decorative Elements -->
            ...
            <!-- Copyright -->
            <div class="text-xs text-blue-200/60 z-10">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name') }}" required placeholder="Budi Santoso" class="pl-10 w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition text-sm">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" id="password" name="password" required placeholder="Minimal 8 karakter" class="pl-10 pr-10 w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition text-sm">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" id="password_confirmation" name="password_confirmation" required placeholder="Ulangi password" class="pl-10 pr-10 w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition text-sm">
